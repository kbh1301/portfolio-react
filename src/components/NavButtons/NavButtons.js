...
const NavButtons = ({ bannerBarScroll, showContact, route, source }) => {
    ...
    const tabBtnCSS = () =>
        source === 'Navigation' ? "bg-light-blue pa2 link grow shadow-hover f6 f5-l br-pill dib mr3 mr4-l" :
        source === 'Banner' ? "f4 no-underline grow shadow-hover dib v-mid bg-light-blue black ph4 pv2 mb3 mt3 ml2 mr2 br-pill" :
        ""
    const contactBtnCSS = () =>
        source === 'Navigation' ? "bg-blue link grow shadow-hover white f6 f5-l dib pa2 i b--black br-pill" :
