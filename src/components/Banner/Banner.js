...
const Banner = ({ bannerBar, bannerBarScroll }) => {
        ...
        <header class="">
            <div id="bannerMain" class="cover bg-left bg-center-l" style={{backgroundImage: `url(${banner})`}}>
                <div id="bannerMinor" class="bg-black-70 flex justify-center items-center w-100">
                    <div class="w-100">
                        <div className='cusWrapper dib w4 h4 mt4 br-100 ba bw2 b--light-blue grow'>
                            <img src={avi} className="w4 cusWrapperImg block" alt="Avatar"/>
                        </div>
                ...
                <div id="bannerBar" ref={bannerBar} className="bg-light-blue bb bt b--white cusMar">
                    ...
                    <p class="f4 no-underline grow shadow-hover dib v-mid bg-blue white ph4 pv2 mb3 mt3 ml2 mr2 br-pill i" href="">Contact Me</p>
                </div>
            </div>
        </header>        
    );
