...
const Navigation = ({ bannerBarScroll, showContact }) => {
    ...
    return(
        <nav class="flex bb b--black bg-light-blue cus-bar fixed w-100 z-9999 slideDown">
            ...
            <div class="flex-grow pa3 flex items-center ml-auto">
                ...
                <p class="bg-blue link grow shadow-hover white f6 f5-l dib pa2 i b--black br-pill" onClick={() => showContact()} title="Contact Me">Contact Me</p>
            </div>
        </nav>
    );
}
